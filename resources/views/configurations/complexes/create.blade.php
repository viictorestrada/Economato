...
<div class="modal fade" data-backdrop="static" id="modcomplex" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card border-secondary">
                <div class="card-body">
                  <form action="{{ url('complex') }}" method="post">
                    @csrf
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select class="form-control {{$errors->has('id_region') ? 'is-invalid' : ''}}" name="id_region" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control {{$errors->has('complex_name') ? 'is-invalid' : ''}}" name="complex_name" value="{{old('complex_name')}}" required autocomplete="off">
